...
// Marka wordmark artık font değil — Wordmark bileşeni (ve OG/gen-icons) outline SVG path
// (Switzer-Extrabold'dan çıkarılmış "Shiftle"). Switzer localFont'u kaldırıldı; kullanıcısı yok.
