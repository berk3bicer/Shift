...
// Marka wordmark artık font değil — Wordmark bileşeni outline SVG path (Switzer-Extrabold'dan
// çıkarılmış "Shiftle"). Bu yüzden Switzer localFont'u kaldırıldı; panelde font kullanıcısı yok.
